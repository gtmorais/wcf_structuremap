...
namespace WCF_IOC.Infra.CrossCutting.Common.Caching
{
    public class CacheProvider
    {
        ...
        public static void Set(string key, object data, int? time = null)
        {
            ...
            {
                AbsoluteExpiration = DateTime.Now + TimeSpan.FromMinutes(time ?? Convert.ToDouble(ConfigurationManager.AppSettings["CacheTime"]))
            };
